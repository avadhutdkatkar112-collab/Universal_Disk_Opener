...
type Job struct {
	ID         string                     `json:"id"`
	Capability capability.Capability      `json:"-"`
	Context    capability.ExecutionContext `json:"context"`
...
func (jm *JobManager) Submit(parentCtx context.Context, cap capability.Capability, execCtx capability.ExecutionContext) *Job {
